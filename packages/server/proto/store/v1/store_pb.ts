...
/**
 * @generated from message store.v1.GreetRequest
 */
export class GreetRequest extends Message<GreetRequest> {
  ...
  static readonly typeName = "store.v1.GreetRequest";
...
/**
 * @generated from message store.v1.GreetResponse
 */
export class GreetResponse extends Message<GreetResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "store.v1.GreetResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
