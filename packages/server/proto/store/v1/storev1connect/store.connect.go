...
const (
	...
	GreetServiceName = "store.v1.GreetService"
)

// GreetServiceClient is a client for the store.v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *connect_go.Request[v1.GreetRequest]) (*connect_go.Response[v1.GreetResponse], error)
}

// NewGreetServiceClient constructs a client for the store.v1.GreetService service. By default, it
...
func NewGreetServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GreetServiceClient {
	...
	return &greetServiceClient{
		greet: connect_go.NewClient[v1.GreetRequest, v1.GreetResponse](
			httpClient,
			baseURL+"/store.v1.GreetService/Greet",
			opts...,
		),
	}
}
...
// Greet calls store.v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the store.v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/store.v1.GreetService/Greet", connect_go.NewUnaryHandler(
		"/store.v1.GreetService/Greet",
		svc.Greet,
		opts...,
	))
	return "/store.v1.GreetService/", mux
}
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect_go.Request[v1.GreetRequest]) (*connect_go.Response[v1.GreetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("store.v1.GreetService.Greet is not implemented"))
}
